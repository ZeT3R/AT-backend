...
def form_json1(ret_json, in_json):
    ret_json = clear_json(ret_json, "format_1_json.json")
...
def form_json3(ret_json, in_json):
    ret_json = clear_json(ret_json, "format_3_json.json")
...
def form_json4(ret_json, in_json):
    ret_json = clear_json(ret_json, "format_4_json.json")
...
def clear_json(json_to_format, format):
    shutil.copy2(json_to_format,
                 format)  # copy empty json (proto) to our json with results (file)
